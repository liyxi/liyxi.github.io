...
<div class="custom_card" id="h2-publications">
    ...
    <table>
        <tr id="publication-num-3">
            ...
            <div>In Neurocomputing, 2022. </div>
            </td>
        </tr>
    </table>
    <h3>Conference</h3>
    ...
    <table>
        <tr id="publication-num-5">
            ...
            <div>In The AAAI Conference on Artificial Intelligence (AAAI), 2024. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-6">
            ...
            <div>In International Conference on Learning Representations (ICLR), 2024. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-7">
            ...
            <div>In The IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2023. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-8">
            ...
            <div>In Advances in Neural Information Processing Systems (NeurIPS), 2023. 🚩 <span style="color:red">Spotlight</span>.</div>
            </td>
        </tr>
    </table>
    <table>
    ...
    <table>
        <tr id="publication-num-10">
            ...
            <div>In International Conference on Machine Learning (ICML), 2022. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-11">
            ...
            <div>In The IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2022. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-12">
            ...
            <div>In The AAAI Conference on Artificial Intelligence (AAAI), 2021. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-13">
            ...
            <div>In Advances in Neural Information Processing Systems (NeurIPS), 2021. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-14">
            ...
            <div>In The IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2021. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-15">
            ...
            <div><em><b>Yanxi Li</b>, Minjing Dong, Yunhe Wang & Chang Xu</em></div>
            <div>In International Conference on Machine Learning (ICML), 2020. </div>
            </td>
        </tr>
    </table>
    <table>
        <tr id="publication-num-16">
            ...
            <div><em><b>Yanxi Li</b>, Zhaohui Yang, Yunhe Wang & Chang Xu</em></div>
            <div>In Advances in Neural Information Processing Systems (NeurIPS), 2020. </div>
            </td>
        </tr>
    </table>
    <h3>Pre-printing</h3>
    ...
    <table>
        <tr id="publication-num-18">
            ...
            <div>In arXiv preprint. arXiv:2403.10935, 2024. </div>
            </td>
        </tr>
    </table>
    <table>
